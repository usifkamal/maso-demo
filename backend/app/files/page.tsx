...
export default function FilesPage() {
  ...
  const { data: documents } = useQuery<DocumentWithPath[]>(['files'], async () => {
    ...
    // Ensure we always return an array for easier consumption in the UI
    return (data ?? []) as DocumentWithPath[];
  });
